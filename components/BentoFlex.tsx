        ...
        <section className="py-32 relative bg-background/50 overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="text-center mb-24 animate-reveal">
                    <h2 className="text-5xl md:text-7xl font-black mb-6 tracking-tight">Our Expertise</h2>
                ...
                <div className="flex flex-col lg:flex-row gap-8 min-h-[600px]">
                    ...
                    <motion.div
                        layout
                        className="flex-[2] glass bg-card/40 border-white/5 p-12 rounded-[3rem] relative overflow-hidden group hover:border-primary/50 transition-all duration-500 cursor-default"
                    >
                        <div className="relative z-10 h-full flex flex-col justify-between">
                            <div>
                                ...
                                <h3 className="text-4xl font-black mb-6">AI Agents & LLMs</h3>
                    ...
                    <div className="flex-1 flex flex-col gap-8">
                        ...
                        <motion.div
                            layout
                            className="flex-1 glass bg-card/40 border-white/5 p-10 rounded-[2.5rem] group hover:border-secondary/50 transition-all duration-500 cursor-default"
                        >
                        ...
                        <motion.div
                            layout
                            className="flex-1 glass bg-card/40 border-white/5 p-10 rounded-[2.5rem] group hover:border-accent-foreground/50 transition-all duration-500 cursor-default"
                        >
