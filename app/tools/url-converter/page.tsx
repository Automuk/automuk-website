            ...
            <div className="max-w-6xl mx-auto">
                ...
                >
                    <h1 className="text-4xl md:text-6xl font-black text-white mb-6">
                        URL <span className="text-[#3168FA]">Converter</span>
                    </h1>
                    <p className="text-[#94A3B8] text-lg max-w-2xl mx-auto">
                        Quickly encode or decode URL components for safe web transmission.
                    </p>
                </motion.div>
                ...
                <div className="grid lg:grid-cols-2 gap-8">
                    ...
                    <motion.div variants={fadeInUp} initial="initial" animate="animate">
                        <Card className="glass bg-[#1E293B]/40 border-[#334155] p-6 h-full flex flex-col">
                            ...
                            <Textarea
                                placeholder={mode === "encode" ? "Enter text here..." : "Paste URL encoded string here..."}
