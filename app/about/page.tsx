            ...
            <PageContainer>
                <div className="max-w-5xl mx-auto my-32">
                    <div className="text-center mb-24 animate-fade-in-up">
                        <h1 className="text-5xl md:text-8xl font-black mb-10 tracking-tight leading-tight">Built for Efficiency, <br />Dedicated to Outcomes.</h1>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center mb-40">
                        <div className="space-y-8 animate-fade-in-up stagger-1">
                            <h2 className="text-4xl font-bold tracking-tight">Small Team, Big Impact</h2>
                        ...
                        <div className="relative group animate-fade-in-up stagger-2">
                            ...
                            <div className="relative glass bg-card/40 border border-white/10 p-12 rounded-[2.5rem] h-full flex flex-col justify-center transform group-hover:scale-[1.02] transition-all duration-500">
                                <blockquote className="text-3xl italic font-medium mb-10 leading-snug">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-20 px-4">
                        {[
                            ...
                            <div key={value.title} className={`p-10 glass bg-card/30 border border-white/5 rounded-3xl group hover:border-primary/40 transition-all animate-fade-in-up stagger-${i + 1}`}>
                                <value.icon className="h-10 w-10 text-primary mb-6 group-hover:scale-110 transition-transform" />
